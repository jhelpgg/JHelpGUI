...
public class SerializerGUI
{
    ...
    *           Markup parameters
    * @throws ExceptionXML
    *            If the markup and parameters not represents a valid percentage
    */
    ...
    * @return Parsed font
    * @throws ExceptionXML
    *            If markup and parameters not describes a valid font
    */
   public static JHelpFont deserialzeFont(final String markupName, final Hashtable<String, String> parameters) throws ExceptionXML
   {
      ...
      if(size < 1)
      {
         throw new InvalidParameterValueException(Constants.PARAMETER_SIZE, markupName, "The parameter must be >=1 not " + size);
      }

      final boolean bold = ParserXML.obtainBoolean(markupName, parameters, Constants.PARAMETER_BOLD, false, false);
      final boolean italic = ParserXML.obtainBoolean(markupName, parameters, Constants.PARAMETER_ITALIC, false, false);
      final boolean underline = ParserXML.obtainBoolean(markupName, parameters, Constants.PARAMETER_UNDERLINE, false, false);
    ...
    * @throws ExceptionXML
    *            If markup or parameters don't represents a valid gradient
    */
    ...
    * @return Parsed gradient
    * @throws ExceptionXML
    *            If markup not close properly an horizontal or vertical gradient
    */
   public static JHelpPaint endDeseralizeGradientHorizontalOrVertical(final String markupName) throws ExceptionXML
   {
      ...
      if(Constants.MARKUP_GRADIENT_HORIZONTAL.equals(markupName) == true)
      {
         ...
         {
            percent = SerializerGUI.PERCENTS.getElement(i);
    ...
    * 
    * @param gradient
    *           Gradient horizontal to serialize
    * @param dynamicWriteXML
    *           XML where write
    * @throws IOException
    *            On writing issue
    */
   public static void serialize(final JHelpGradientHorizontal gradient, final DynamicWriteXML dynamicWriteXML) throws IOException
   {
    ...
    * 
    * @param gradient
    *           Gradient vertical to serialize
    * @param dynamicWriteXML
    *           XML where write
    * @throws IOException
    *            On writing issue
    */
   public static void serialize(final JHelpGradientVertical gradient, final DynamicWriteXML dynamicWriteXML) throws IOException
   {
    ...
    *           Markup parameters
    * @throws ExceptionXML
    *            If markup or parameters didn't describes a valid horizontal or vertical gradient
    */
