...
public class ASMDescriptor extends LanguageDescriptor
{
    ...
    public ASMDescriptor()
    {
        ...
        this.associate(Rules.KEY_WORD, "this", "class", "}", "extends", "field", "field_reference", "implements", "import",
                       "method", "{", "package", "parameter", "private", "protected", "public", "return", "static",
                       "throws");
        this.associate(Rules.KEY_WORD, Pattern.compile("\\<init\\>"), 0);
        this.associate(Rules.OPERANDE, "AALOAD", "AASTORE", "ACONST_NULL", "ALOAD", "ANEWARRAY", "ARETURN", "ARRAYLENGTH",
                       "ASTORE", "ATHROW", "BALOAD", "BASTORE", "BIPUSH", "BREAKPOINT", "CALOAD", "CASTORE", "CHECKCAST",
                       "D2F", "D2I", "D2L", "DADD", "DALOAD", "DASTORE", "DCMPG", "DCMPL", "DCONST", "DDIV", "DLOAD",
                       "DMUL", "DNEG", "DREM", "DRETURN", "DSTORE", "DSUB", "DUP", "DUP_X1", "DUP_X2", "DUP2", "DUP2_X1",
                       ...
                       "GOTO_W", "I2B", "I2C", "I2D", "I2F", "I2L", "I2S", "IADD", "IALOAD", "IAND", "IASTORE", "ICONST",
                       "IDIV", "IF_ACMPEQ", "IF_ACMPNE", "IF_ICMPEQ", "IF_ICMPGE", "IF_ICMPGT", "IF_ICMPLE", "IF_ICMPLT",
                       "IF_ICMPNE", "IFEQ", "IFGE", "IFGT", "IFLE", "IFLT", "IFNE", "IFNONNULL", "IFNULL", "IINC", "ILOAD",
                       ...
                       "IUSHR", "IXOR", "JSR", "JSR_W", "L2D", "L2F", "L2I", "LADD", "LALOAD", "LAND", "LASTORE", "LCMP",
                       "LCONST", "LDC", "LDC_W", "LDC2_W", "LDIV", "LLOAD", "LMUL", "LNEG", "LOOKUPSWITCH", "LOR", "LREM",
                       "LRETURN", "LSHL", "LSHR", "LSTORE", "LSUB", "LUSHR", "LXOR", "MONITORENTER", "MONITOREXIT",
                       "MULTIANEWARRAY", "NEW", "NEWARRAY", "NOP", "POP", "POP2", "PUSH", "PUTFIELD", "PUTSTATIC", "RET",
                       "RETURN", "SALOAD", "SASTORE", "SIPUSH", "SWAP", "SWITCH", "TABLESWITCH", "CATCH", "LABEL", "SUB_C",
                       "SUB_E", "SUB_S", "TRY", "VAR");
    }
}
