...
public class LanguageDescriptor
{
     ...
     */
    public final void associate(Rules rules, Pattern pattern, int group)
    {
        if (rules == null)
        {
     ...
     */
    public final void associate(final Rules rules, final String... keyWords)
    {
        if (rules == null)
        {
            throw new NullPointerException("rules MUST NOT be null !");
     ...
     * The privious description on {@link JHelpAutoStyledTextArea} aren't remove, this is just an addition<br>
     ...
     */
    public final void addToAutoStyledText(JHelpAutoStyledTextArea autoStyledTextArea)
    {
        String name;
        ...
        for (Map.Entry<Rules, List<Pair<Pattern, Integer>>> entry : this.descriptors.entrySet())
        {
            ...
            {
                autoStyledTextArea.associate(name, pair.element1, pair.element2);
            }
        }
    }
}
