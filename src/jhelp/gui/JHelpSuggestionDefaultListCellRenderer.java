 ...
 * @author JHelp <br>
 * @param <INFORMATION>
 *           Information carry with the suggestion
 */
      ...
      extends JHelpLabelListCellRenderer<SuggestionElement<INFORMATION>>
{
    ...
    *
    * @param element
    *           Suggestion element to renderer
    * @param index
    *           Index in list
    * @see jhelp.gui.JHelpLabelListCellRenderer#update(java.lang.Object, int)
    */
   @Override
   protected void update(final SuggestionElement<INFORMATION> element, final int index)
   {
      final StringBuilder text = new StringBuilder(element.getKeyWord());
      final INFORMATION information = element.getInformation();
