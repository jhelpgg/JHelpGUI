      ...
      extends ParagraphView
{
   ...
   public LineNumberParagraphView(final Element element)
   {
      ...
      if(this.numberFont == null)
      {
         ...
         this.setFont(LineNumberParagraphView.DEFAULT_NUMBER_FONT);
      }
   }
    ...
    *           New font
    */
   private void setFont(final JHelpFont numberFont)
   {
    ...
    *           Graphics for paint
    * @param alloc
    *           Paragraph child rectangle
    * @param index
    *           Index of child
    * @see javax.swing.text.BoxView#paintChild(java.awt.Graphics, java.awt.Rectangle, int)
    */
   @Override
   protected void paintChild(final Graphics g, final Rectangle alloc, final int index)
   {
      ...
      final JHelpImage number = this.numberFont.createImage(String.valueOf(this.indexInParent() + 1), this.foreground, this.background);
      // We center the number inside the reserved area
      g.drawImage(number.getImage(), alloc.x - ((this.getLeftInset() + number.getWidth()) >> 1), alloc.y + ((alloc.height - number.getHeight()) >> 1), null);

      if(this.additionalText != null)
      {
         g.drawImage(this.additionalText.getImage(), alloc.x + alloc.width + LineNumberParagraphView.ADDITIONAL_MARGIN,
    ...
    *
    * @param attributes
    *           Attributes with insets
    * @see javax.swing.text.CompositeView#setParagraphInsets(javax.swing.text.AttributeSet)
    */
   @Override
    ...
    * {@inheritDoc}
    *
    * @see javax.swing.text.ParagraphView#setPropertiesFromAttributes()
    */
   @Override
   protected void setPropertiesFromAttributes()
   {
      ...
      if(attributeSet != null)
      {
         ...
         if(value != null)
         {
            ...
            {
               this.setFont((JHelpFont) value);
            }
            else if(value instanceof Font)
            {
               this.setFont(new JHelpFont((Font) value, false));
            }
         }
