        ...
        extends JEditorPane
{
     ...
     */
    public void createStyle(final String name, final String fontFamily, final int fontSize, final boolean bold, final
    ...
    public void decorate(
            @NotNull
                    Decorator decorator)
    {
        this.setDefaultStyle(DEFAULT_STYLE);
        this.clearStyles();
        ...
        for (Rules rules : Rules.values())
        {
            ...
            this.createStyle(rules.name(), familly, decoration.getTextSize()
                                                              .computeSize(fontSzie),
                             decoration.isBold(), decoration.isItalic(), decoration.isUnderline(),
                             decoration.getForeground(), decoration.getBackground());
        }

        this.setSymbolStyle(Rules.SYMBOL.name());
        this.setDefaultStyle(Rules.DEFAULT.name());
    }
    ...
    {
        for (Object name : new EnumerationIterator<Object>(this.autoStyledDocument.getStyleNames()))
        {
            if (name != null)
            {
    ...
    {
        if (name.equals("default") || name.equals(this.defaultStyle) || name.equals(JHelpAutoStyledTextArea.DEFAULT_STYLE))
        {
     ...
     */
    public void changeStyle(final String name, final String fontFamily, final int fontSize, final boolean bold, final
    boolean italic, final boolean underline,
                            final Color foreground, final Color background)
    {
        if (name == null)
    ...
    public void scrollToPosition(int position)
    {
        ...
        position = UtilMath.limit(position, 0, this.getText()
                                                   .length());
            ...
            extends ThreadedVerySimpleTask
    {
        ...
        protected void doVerySimpleAction()
        {
            ...
            for (final StyleArea styleArea : styleAreaList)
            {
                ...
                {
                    JHelpAutoStyledTextArea.this.autoStyledDocument.setCharacterAttributes(start, styleArea.start - start,
                                                                                           defaultStyle, true);
                }
