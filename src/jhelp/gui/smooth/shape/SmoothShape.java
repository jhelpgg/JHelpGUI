      ...
      implements JHelpConstantsSmooth
{
         ...
         final ShadowLevel level, final int shadow)
   {
      ...
      {
         this.drawShadow(level.getNumberOfPixels(), shadow, parent, shapeInformation.backroundShape);
      }

      parent.fillShape(shapeInformation.backroundShape, color);
         ...
         final ShadowLevel level, final int shadow)
   {
      ...
      parent.fillShape(shapeInformation.backroundShape, texture);
         ...
         final ShadowLevel level, final int shadow)
   {
      ...
      parent.fillShape(shapeInformation.backroundShape, paint);
    ...
    *           Shadow level
    */
   public final void fillShape(final JHelpImage parent, final int x, final int y, final int width, final int height, final int color, final ShadowLevel level)
   {
      final ShapeInformation shapeInformation = this.computeShape(x, y, width, height, level);
      parent.fillShape(shapeInformation.backroundShape, color);
   }
