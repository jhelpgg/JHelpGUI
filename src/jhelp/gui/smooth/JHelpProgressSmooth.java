      ...
      extends JHelpComponentSmooth
{
    ...
    *           Font to use
    */
   public JHelpProgressSmooth(final int progressColor, final int background, final int border, final int foreground, final JHelpFont font)
   {
      ...
      this.setShadowLevel(ShadowLevel.NEAR);
   }
   ...
   {
      this.progress = UtilMath.limit(progress, this.progress, this.maximum);
      ...
      int timeLeft = (int) (((this.maximum - this.progress) * (System.currentTimeMillis() - this.startTime)) / this.progress);
      ...
      this.text = this.font.createMask(UtilText.concatenate(this.progress, "/", this.maximum, " left ", hours, ':', zeroMinutes, minutes, ':', zeroSeconds,
