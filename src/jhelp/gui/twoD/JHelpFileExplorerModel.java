      ...
      extends JHelpListModel<File>
{
   ...
   static
   {
      ...
      JHelpFileExplorerModel.FILTER_IMAGES.setAcceptDirectory(false);

      FILTER_SOUNDS = new FileFilter();
      JHelpFileExplorerModel.FILTER_SOUNDS.setAcceptDirectory(false);
    ...
    * 
    * @param directory
    *           Starting directory (Use {@code null} for computer root)
    */
    ...
    *           Starting directory (Use {@code null} for computer root)
    * @param filter
    *           File filter to use (Use {@code null} for all files (includes hidden and virual link))
    */
    ...
    * 
    * @param information
    *           Iformation to get its cell size
    * @return Cell size of the information
    * @see jhelp.gui.twoD.JHelpListModel#getCellSize(java.lang.Object)
    */
   @Override
   public Dimension getCellSize(final File information)
   {
    ...
    */
   @Override
   public File getElement(final int index)
   {
    ...
    * 
    * @param information
    *           Information to get tooltip
    * @return Information's tooltip or {@code null} if no tooltip
    * @see jhelp.gui.twoD.JHelpListModel#getToolTip(java.lang.Object)
    */
   @Override
   public String getToolTip(final File information)
   {
    ...
    * 
    * @param information
    *           Information to get its representation
   ...
   public JHelpImage obtainImageRepresentation(final File information)
   {
      ...
      final JHelpMask mask = JHelpFileExplorerModel.FONT.createMask(JHelpFileExplorerModel.WIDTH_LIMITER.convert(text));
      ...
      image.paintMask(icon.getWidth(), (height - mask.getHeight()) >> 1, mask, JHelpFileExplorerModel.FOREGROUND, 0, false);
      image.endDrawMode();
