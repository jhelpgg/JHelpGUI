        ...
        implements MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, JHelpWindow2D
{
    ...
    private final ThreadedSimpleTask<Pair<KeyListener, KeyEvent>>          signalKeyEventTask   = new
            ThreadedSimpleTask<Pair<KeyListener, KeyEvent>>()
    {
        /**
    ...
    private final ThreadedSimpleTask<Pair<JHelpMouseListener, MouseEvent>> signalMouseEventTask = new
            ThreadedSimpleTask<Pair<JHelpMouseListener, MouseEvent>>()
    {
        /**
    ...
    private void signalKeyEvent(final KeyEvent keyEvent)
    {
        ...
        ThreadManager.THREAD_MANAGER.doThread(this.signalKeyEventTask,
    ...
    public void mouseClicked(final MouseEvent e)
    {
        ...
        if (triplet != null)
        {
            if (triplet.element1.isFocusable())
            {
            ...
            {
                ThreadManager.THREAD_MANAGER.doThread(this.signalMouseEventTask,
                                                      new Pair<JHelpMouseListener, MouseEvent>(triplet.element2,
                                                                                               triplet.element3));
            }
        }
    }
    ...
    private Triplet<JHelpComponent2D, JHelpMouseListener, MouseEvent> obtainMouseArea(final MouseEvent event)
    {
        ...
        if (size > 0)
        {
            ...
            if ((pair == null) && (MouseEvent.MOUSE_CLICKED == event.getID()) && (dialog.isClikOutClose())
     ...
     *           Mouse event description
     */
    private void updateMousePosition(final JHelpComponent2D component2d, final int mx, final int my,
                                     final MouseEvent mouseEvent)
    {
        if (this.overComponent != null)
        {
            ...
            ThreadManager.THREAD_MANAGER.doThread(this.signalMouseEventTask, new Pair<JHelpMouseListener, MouseEvent>(
                    this.overComponent.getMouseListener(), me));
        }
        ...
        if (component2d != null)
        {
            ...
            ThreadManager.THREAD_MANAGER.doThread(this.signalMouseEventTask,
                                                  new Pair<JHelpMouseListener, MouseEvent>(component2d.getMouseListener(),
                                                                                           me));
        }
     ...
     */
    public synchronized void printTips(int x, int y, final String tips, final JHelpFont font, final int colorText,
                                       ...
                                       final int colorBorder, final JHelpTextAlign textAlign, final boolean borderLetter)
    {
        ...
        synchronized (imageOver)
        {
            ...
            for (final JHelpTextLineAlpha textLine : pair.element1)
            {
                ...
                imageOver.paintAlphaMask(x + textLine.getX() + 3, y + textLine.getY() + 3, textLine.getMask(), colorText);
            }
     ...
     */
    public void showOptionPaneInput(final OptionPaneMessageType optionPaneMessageType, final String message,
    ...
    {
        this.showOptionPaneInput(optionPaneMessageType, null, message, "", hasCancel, hasNo, optionPaneListener, actionID,
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneInput(final OptionPaneMessageType optionPaneMessageType, final String title,
                                    ...
                                    final Object developerInformation)
    {
        ...
        if (optionPaneListener == null)
        {
            throw new NullPointerException(
                    "optionPaneListener musn't be null (You asked a question, so you should be interest by the answer)");
        }
     ...
     */
    private void showOptionPane(final String title, final OptionPaneMessageType optionPaneMessageType,
                                final String message, final String editText,
                                final boolean hasCancel, final boolean hasNo,
                                final JHelpOptionPaneListener optionPaneListener, final int actionID,
                                final Object developerInformation)
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneInput(final String message, final boolean hasCancel, final boolean hasNo,
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneInput(final String message, final String editText, final boolean hasCancel,
                                    final boolean hasNo,
                                    final JHelpOptionPaneListener optionPaneListener, final int actionID,
                                    final Object developerInformation)
    {
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneInput(final String title, final String message, final String editText,
                                    final boolean hasCancel, final boolean hasNo,
                                    final JHelpOptionPaneListener optionPaneListener, final int actionID,
                                    final Object developerInformation)
    {
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneMessage(final OptionPaneMessageType optionPaneMessageType, final String title,
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneMessage(final String message, final JHelpOptionPaneListener optionPaneListener,
                                      final int actionID,
                                      final Object developerInformation)
    {
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneQuestion(final OptionPaneMessageType optionPaneMessageType, final String message,
                                       final boolean hasCancel, final boolean hasNo,
                                       final JHelpOptionPaneListener optionPaneListener, final int actionID,
                                       final Object developerInformation)
    {
        this.showOptionPaneQuestion(optionPaneMessageType, null, message, hasCancel, hasNo, optionPaneListener, actionID,
                                    developerInformation);
    }
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneQuestion(final OptionPaneMessageType optionPaneMessageType, final String title,
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneQuestion(final String message, final boolean hasCancel, final boolean hasNo,
                                       final JHelpOptionPaneListener optionPaneListener,
                                       final int actionID, final Object developerInformation)
    {
     ...
     *           Object given back to the listener
     */
    public void showOptionPaneQuestion(final String title, final String message, final boolean hasCancel,
                                       final boolean hasNo,
                                       final JHelpOptionPaneListener optionPaneListener, final int actionID,
                                       final Object developerInformation)
    {
        this.showOptionPaneQuestion(OptionPaneMessageType.QUESTION, title, message, hasCancel, hasNo, optionPaneListener,
                                    actionID, developerInformation);
    }
