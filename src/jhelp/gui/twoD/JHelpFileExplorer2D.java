        ...
        implements JHelpListListener<File>, JHelpOptionPaneListener
{
    ...
    private static final ThreadedSimpleTask<Triplet<JHelpFileExplorer2D, JHelpFileExplorerListener, Pair<File,
            Integer>>> TASK_FILE_CHOOSEN       = new ThreadedSimpleTask<Triplet<JHelpFileExplorer2D,
            JHelpFileExplorerListener, Pair<File, Integer>>>()
    {
        /**
         * Signal
         * to
    ...
    private static final ThreadedSimpleTask<Triplet<JHelpFileExplorer2D, JHelpFileExplorerListener, Pair<File,
            Integer>>> TASK_SELECTION_CHANGE   = new ThreadedSimpleTask<Triplet<JHelpFileExplorer2D,
            JHelpFileExplorerListener, Pair<File, Integer>>>()
    {
        /**
         * Signal
     ...
     */
    @Override
    public void listSelectionChanged(final JHelpList2D<File> list2d, final int selecttedIndex, final File information,
            ...
            synchronized (this.listeners)
            {
                for (final JHelpFileExplorerListener listener : this.listeners)
                {
                    ThreadManager.THREAD_MANAGER.doThread(JHelpFileExplorer2D.TASK_SELECTION_CHANGE,
                                                          new Triplet<JHelpFileExplorer2D, JHelpFileExplorerListener,
                                                                  Pair<File, Integer>>(
                                                                  this, listener, new Pair<File, Integer>(information,
                                                                                                          selecttedIndex)));
                }
            }
    ...
    private void renameFile(final File source, final File destination)
    {
        ...
        {
            Debug.printException(exception, "Failed to rename ", source.getAbsolutePath(), " to ",
