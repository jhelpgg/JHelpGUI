      ...
      implements FoldingAreaInterface
{
    ...
    * 
    * @param color
    *           Background color used if <b>paint</b> is {@code null}
    * @param paint
    *           Background paint
    * @param title
    *           Test to print as title
    * @param font
    *           Font to use
    * @param colotText
    *           Foreground color if <b>paintText</b> is {@code null}
    * @param paintText
    *           Foreground paint
    */
   public FoldingAreaTitle(final int color, final JHelpPaint paint, final String title, final JHelpFont font, final int colotText, final JHelpPaint paintText)
   {
      this.color = color;
      this.paint = paint;
      this.title = title;
    ...
    *           Image where draw
    * @param fold
    *           Indicates if content component is fold
    * @param foldingAreaPosition
    *           Header position relative to component content
    * @see jhelp.gui.twoD.FoldingAreaInterface#paintArea(int, int, int, int, jhelp.util.gui.JHelpImage, boolean,
    *      jhelp.gui.twoD.JHelpFoldable2D.FoldingAreaPosition)
    */
   @Override
