      ...
      implements JHelpActionListener, JHelpFileExplorerListener
{
         ...
         extends Thread
   {
      ...
      public void run()
      {
         while(this.alive)
         {
            ...
            JHelpFileChooser2D.this.labelImage2DPreview.setImage(JHelpImage.DUMMY);

            if(file != JHelpFileChooser2D.NO_IMAGE)
            {
               JHelpFileChooser2D.this.labelImage2DPreview.setFile(file);
            }
   ...
   private static final ThreadedSimpleTask<Triplet<Boolean, JHelpFileChooser2DListener, File>> SIGNAL_CHOOSE_OR_CANCEL = new ThreadedSimpleTask<Triplet<Boolean, JHelpFileChooser2DListener, File>>()
                                                                                                                       {
                                                                                                                          /**
                                                                                                                           * Signal
                                                                                                                           * to
   ...
   /** Special fiale for indicates no image */
   static final File                                                                           NO_IMAGE                = new File("");
   /** Special fiale for indicates no sound */
   ...
   static
   {
      ...
      JHelpFileChooser2D.FILTER_IMAGE.setAcceptDirectory(false);

      FILTER_SOUND = new FileFilter();
      JHelpFileChooser2D.FILTER_SOUND.setAcceptDirectory(false);
    ...
    */
   public static boolean isFileChooserShowing()
   {
    ...
    * 
    * @param fileChooser2DListener
    *           Listener to callback when user make his choice
    */
    ...
    *           Filter to use
    */
   public static void showFileChooser(final JHelpFileChooser2DListener fileChooser2DListener, final FileFilter fileFilter)
   {
    ...
    *           Starting directory
    */
   public static void showFileChooser(final JHelpFileChooser2DListener fileChooser2DListener, final FileFilter fileFilter, final File directory)
   {
      if(fileChooser2DListener == null)
      {
         throw new NullPointerException("fileChooser2DListener musn't be null");
      }
      ...
      JHelpFileChooser2D.FILE_CHOOSER.setAutomaticRefresh(true);
   }
    ...
    * 
    * @param onClosing
    *           Indicates if already by {@link #canCloseNow()}
    */
    ...
    * @param selectedIndex
    *           Choosen fille index
    * @see jhelp.gui.twoD.JHelpFileExplorerListener#fileExplorerFileChoosen(jhelp.gui.twoD.JHelpFileExplorer2D, java.io.File,
    *      int)
    */
   @Override
   public void fileExplorerFileChoosen(final JHelpFileExplorer2D fileExplorer2D, final File selectedFile, final int selectedIndex)
   {
      this.doOk();
   }
    ...
    */
   @Override
   public void fileExplorerSelectionChange(final JHelpFileExplorer2D fileExplorer2D, final File selectedFile, final int selectedIndex)
   {
      String title;
      ...
      {
         title = ResourcesGUI.RESOURCE_TEXT.getText(ResourcesGUI.FILE_CHOOSER_TITLE_HEADER) + " : " + selectedFile.getAbsolutePath();
      }
    ...
    *           Start directory
    */
   public void initialize(final JHelpFileChooser2DListener fileChooser2DListener, final FileFilter fileFilter, final File directory)
   {
      this.loadImage = new LoadImage();
      this.loadSound = new LoadSound();
      this.fileChooser2DListener = fileChooser2DListener;
      this.fileExplorer2D.setFileFilter(fileFilter);
      this.fileExplorer2D.setDirectory(directory);
