        ...
        implements KeyListener, JHelpMouseListener
{
     ...
     *           Number of lines
     */
    public JHelpEditText(final JHelpFont font, final int foregroundColor, final int cursorColor, final int columns,
                         final int lines)
    {
    ...
    private void updateEditText()
    {
        ...
        synchronized (this.imageEdit)
        {
            ...
            for (final JHelpTextLineAlpha textLine : this.textFormated.element1)
            {
    ...
    {
        if ((this.textFormated == null) || (this.textFormated.element1.isEmpty()))
        {
        ...
        final JHelpTextLineAlpha textLine = this.textFormated.element1.get(this.textFormated.element1.size() - 1);
    ...
    private Point computeCursorCoordinate()
    {
        ...
        final JHelpTextLineAlpha textLine = this.textFormated.element1.get(y);
    ...
    private void locateCursorCoordinate(final int x, final int y)
    {
        ...
        if (y <= 0)
        {
            ...
            final JHelpTextLineAlpha textLine = this.textFormated.element1.get(0);
        ...
        for (int i = 0; i < y; i++)
        {
            before += this.textFormated.element1.get(i)
                                                .getText()
                                                .length();
        }
