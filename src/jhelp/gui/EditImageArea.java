      ...
      extends JPanel
{
   ...
   public EditImageArea(final FileChooser fileChooser)
   {
      ...
      if(fileChooser == null)
      {
         throw new NullPointerException("fileChooser musn't be null");
      }
    ...
    * 
    * @param key
    *           Key of resource text (with eventually some "hole")
    * @param parameters
    *           "Holes" replacement
    ...
    * 
    * @param key
    *           Key of resource text (with "hole" : path file, exception message) of the error message
    * @param file
    *           Actual file where error happen
    * @param exception
    *           Exception happen
    */
    ...
    * 
    * @param key
    *           Key of resource text (with "hole" : path file) of the succeed message
    * @param file
    *           Actual file where succeed happen
    */
   ...
   void doAdd()
   {
      final ImageArea imageArea = this.componentImageArea.getImageArea();
   ...
   void doGrid()
   {
      final int horizontal = (Integer) this.spinnerHorizontal.getValue();
      final int vertical = (Integer) this.spinnerVertical.getValue();
      this.componentImageArea.setGrid(horizontal, vertical);
      this.componentImageArea.requestFocus();
      this.componentImageArea.requestFocusInWindow();
   }
   ...
   void doLoad()
   {
      this.fileChooser.setFileFilter(this.filterImage);
      ...
      if(file != null)
      {
         try
         {
            ...
            this.componentImageArea.setJHelpImage(image);
   ...
   void doOpen()
   {
      this.fileChooser.setFileFilter(this.filterArea);
      final File file = this.fileChooser.showOpenFile();
      ...
      if(file != null)
      {
         ...
         try
         {
            ...
            this.componentImageArea.setImageArea(imageArea);
            this.showSucceedMessage("EditImageArea.openSucceed", file);
         }
         catch(final Exception exception)
         {
            Debug.printException(exception, "Failed to load image area  : ", file.getAbsolutePath());
   ...
   void doSave()
   {
      ...
      if(file != null)
      {
         ...
         {
            Debug.printException(exception, "Failed to save image area  : ", file.getAbsolutePath());
