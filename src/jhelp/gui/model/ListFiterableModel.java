 ...
 *           Elements type
 */
public class ListFiterableModel<ELEMENT>
      implements ListModel<ELEMENT>, FilterListener<ELEMENT>
{
   ...
   /**
    * Create a new instance of ListFiterableModel
    */
   public ListFiterableModel()
   {
   ...
   {
      final ListDataEvent listDataEvent = new ListDataEvent(this, ListDataEvent.CONTENTS_CHANGED, Math.min(index1, index2), Math.max(index1, index2));
   ...
   {
      final ListDataEvent listDataEvent = new ListDataEvent(this, ListDataEvent.INTERVAL_ADDED, Math.min(index1, index2), Math.max(index1, index2));
   ...
   {
      final ListDataEvent listDataEvent = new ListDataEvent(this, ListDataEvent.INTERVAL_REMOVED, Math.min(index1, index2), Math.max(index1, index2));
    ...
    * @param filter
    *           Changed filter
    * @see jhelp.gui.model.FilterListener#filterChange(jhelp.gui.model.Filter)
    */
   @Override
    ...
    *
    * @param filter
    *           New filter. Can use <code>null</code> for show all elements
    */
