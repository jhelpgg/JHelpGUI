      ...
      implements ComboBoxModel<String>, Comparator<String>
{
   ...
   private int selectFont(String font)
   {
      ...
      {
         index = 0;
         font = this.fontNames.getElement(0);
      }
   ...
   {
      return this.fontNames.getElement(index);
   }
   ...
   public void updateFontList()
   {
      ...
      this.fireContentChanged(0, this.fontNames.getSize() - 1);
   }
}