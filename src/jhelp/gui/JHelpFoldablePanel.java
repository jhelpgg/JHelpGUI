      ...
      extends JPanel
{
    ...
    *           Font used by bar
    */
   public JHelpFoldablePanel(String title, final JComponent foldComponent, final FoldLocation foldLocation, final JHelpFont font)
   {
      super(new BorderLayout());

      if(foldComponent == null)
      {
         throw new NullPointerException("foldComponent musn't be null");
      }

      if(foldLocation == null)
      {
         throw new NullPointerException("foldLocation musn't be null");
      }
