 ...
 * For a compact version see {@link FontChooserCompact} <br>
 * <br>
...
{
   /**
    * Dialog to show the choose of font <br>
    * <br>
         ...
         implements ActionListener, FontChooserListener
   {
       ...
       * 
       * @param validate
       *           Indicates if it's the OK button
       */
       ...
       *           Event description
       * @see jhelp.gui.event.FontChooserListener#fontChanged(jhelp.gui.event.FontChooserEvent)
       */
      @Override
      ...
      public Font showDialogFont(final Font start)
      {
         if(start != null)
         {
            this.fontChooser.setActualFont(start);
         }
    ...
    * 
    * @param component
    *           Component over the dialog have to appear
    ...
    *           Component over the dialog have to appear
    * @param start
    *           Font to in the dialog at start
   ...
   protected void fireFontChanged()
   {
      ...
      this.listFont.scrollRectToVisible(this.listFont.getCellBounds(this.listFont.getSelectedIndex(), this.listFont.getSelectedIndex()));
    ...
    *           New font
    */
   public void setActualFont(final Font font)
   {
      if(font == null)
      {
