...
public class JHelpTable extends JPanel
{
    ...
    public void addComponent(int x, int y, int width, int height, JComponent component)
    {
        ...
        x = UtilMath.limit(x, 0, this.numberOfColumns - 1);
        y = UtilMath.limit(y, 0, this.numberOfRows - 1);
    ...
    protected void paintChildren(Graphics graphics)
    {
        ...
        for (int i = 0; i < nb; i++)
        {
            ...
            if (component.isVisible() && constraints != null)
            {
                ...
                for (int yy = 0; yy < constraints.height; yy++)
                {
                    ...
                    {
                        cells[xx + constraints.x - minimums.x + (yy + constraints.y - minimums.y) * numberOfColumns] =
                                true;
                    }
                }
            }
        ...
        {
            ThreadManager.THREAD_MANAGER.delayedThread(this.taskFillHoles, holes, 128);
        }
    }
    ...
    {
        this.fireTableColumnWillBeInsert(UtilMath.limit(index, 0, this.numberOfColumns));
        Component               component;
        TableLayout.Constraints constraints;
        int                     nb = this.getComponentCount();
        ...
        this.revalidate();
        this.repaint();
        this.fireTableColumnInserted(UtilMath.limit(index, 0, this.numberOfColumns));
    }
    ...
    {
        this.fireTableRowWillBeInsert(UtilMath.limit(index, 0, this.numberOfRows));
        Component               component;
        TableLayout.Constraints constraints;
        int                     nb = this.getComponentCount();
        ...
        this.revalidate();
        this.repaint();
        this.fireTableRowInserted(UtilMath.limit(index, 0, this.numberOfRows));
    }
    ...
    void decideIfShowPopup(int x, int y)
    {
        ...
        if (size == 1)
        {
            ...
            for (int i = 0; i < nb; i++)
            {
                ...
                if (component.isVisible() && constraints != null && isSelected(constraints))
                {
                    this.manipulatedComponent = component;
                    this.resultConstraints = new TableLayout.Constraints(constraints.x, constraints.y);
                    this.actionUnifyOrSplit.setName(TEXT_KEY_ACTION_SPLIT);
        ...
        this.actionUnifyOrSplit.setName(TEXT_KEY_ACTION_UNION);
     ...
     */
    public static interface CellComponentCreator
    {
        /**
     ...
     */
    public static interface ColumnAndRowsModificationListener extends EventListener
    {
        /**
     ...
     */
    class TaskFillHoles extends ThreadedSimpleTask<List<Point>>
    {
        /**
         * Create task
         */
         ...
         */
        @Override
        protected void doSimpleAction(List<Point> points)
        {
    ...
    class ActionUnifyOrSplit extends GenericAction
    {
        ...
        ActionUnifyOrSplit()
        {
            super(TEXT_KEY_ACTION_UNION, ResourcesGUI.RESOURCE_TEXT);
        }
    ...
    class ActionMoveCell extends GenericAction
    {
        ...
        ActionMoveCell()
        {
            super(TEXT_KEY_ACTION_MOVE, ResourcesGUI.RESOURCE_TEXT);
        }
