      ...
      extends JComponent
{
      ...
      synchronized(this.lock)
      {
         ...
         if(this.foldLocation.horizontal() == true)
         {
            UtilImage.fillTriangle(0, (height - JHelpFoldingComponent.TRIANGLE_SIZE) >> 1, JHelpFoldingComponent.TRIANGLE_SIZE, this.image, wayTriangle,
                  foreground);
            this.image.drawImage(JHelpFoldingComponent.TRIANGLE_SIZE + JHelpFoldingComponent.MARGIN_TRIANGLE, (height - imageText.getHeight()) >> 1, imageText);
         }
         else
         {
            UtilImage.fillTriangle((width - JHelpFoldingComponent.TRIANGLE_SIZE) >> 1, 0, JHelpFoldingComponent.TRIANGLE_SIZE, this.image, wayTriangle,
                  foreground);
            this.image.drawImage((width - imageText.getWidth()), JHelpFoldingComponent.TRIANGLE_SIZE + JHelpFoldingComponent.MARGIN_TRIANGLE, imageText);
         }
   ...
   protected void paintComponent(final Graphics graphics)
   {
      ...
      synchronized(this.lock)
      {
         if(this.image != null)
         {
            graphics.drawImage(this.image.getImage(), (width - this.image.getWidth()) >> 1, (height - this.image.getHeight()) >> 1, null);
         }
      }
   }
