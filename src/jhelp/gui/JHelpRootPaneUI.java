      ...
      extends BasicRootPaneUI
{
         ...
         implements MouseInputListener
   {
      ...
      public void mousePressed(final MouseEvent ev)
      {
         ...
         if(w == null)
         {
            Debug.println(DebugLevel.WARNING, "Widows not found !");
      ...
      public void mouseReleased(final MouseEvent ev)
      {
         ...
         if(this.isMovingWindow == true)
         {
            if(JHelpRootPaneUI.this.content instanceof WindowablePanel.HaveHeaderPanel)
            {
               ...
               final WindowablePanel windowablePanel = ((WindowablePanel.HaveHeaderPanel) JHelpRootPaneUI.this.content).getWindowablePanelParent();
               ...
               else
               {
                  ...
                  if(dropTarget.isAcceptableInformation(information) == true)
                  {
                     ...
                     dropTarget.dropDone(information,//
                           (position.x - location.x) + ResourcesGUI.TRANSLATE_CURSOR, (position.y - location.y) + ResourcesGUI.TRANSLATE_CURSOR);
                  }
                  else
                  {
                     dragSource.fireDragFailed();
   ...
   public static void useJHelpRootPaneUI()
   {
      ...
      try
      {
         ...
         if(className != null)
         {
            ...
            {
               throw new NullPointerException("Can't find the class for the JHelpRootPaneUI installation. No " + className + " ?");
            }
         }
         else
         {
            throw new NullPointerException("Can't find the class name in the look and feel for the JHelpRootPaneUI installation");
         }
      }
    ...
    * @see javax.swing.plaf.basic.BasicRootPaneUI#installUI(javax.swing.JComponent)
    */
   @Override
    ...
    * 
    * @param c
    *           Component to remove the UI
    * @see javax.swing.plaf.basic.BasicRootPaneUI#uninstallUI(javax.swing.JComponent)
    */
   @Override
