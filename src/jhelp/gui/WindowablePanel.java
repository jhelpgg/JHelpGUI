      ...
      implements ActionListener
{
    ...
    * 
    * @param title
    *           Title of looking for windowable panel
    ...
    * 
    * @param windowablePanel
    *           Windowable panel we search intersection
   ...
   public static WindowablePanel getWindowablePanelIntersetected(final WindowablePanel windowablePanel)
   {
      ...
      final Rectangle rectangle = new Rectangle(windowablePanel.panelMain.getLocationOnScreen(), windowablePanel.getRealDimension());
    ...
    * 
    * @param component
    *           Component that search its windowable panel parent
   ...
   public static WindowablePanel getWindowablePanelParent(Component component)
   {
      ...
      while(component != null)
      {
         ...
         if(component instanceof WindowablePanel.HaveHeaderPanel)
         {
            return ((WindowablePanel.HaveHeaderPanel) component).getWindowablePanelParent();
         }
    ...
    *           Icon
    * @param windowable
    *           Indicates if the panel can be detach/attach
    * @param hideable
    *           Indicates if the content can be hide/show
    * @param closable
         ...
         final JComponent componentCenter)
   {
      if(component == null)
      {
         throw new NullPointerException("The component musn't be null !");
      }
    ...
    *           Indicate if the panel can be close
    */
   public WindowablePanel(final JFrame frame, final String title, final Icon icon, final boolean windowable, final boolean hideable, final boolean closable)
   {
         ...
         final JComponent componentCenter)
   {
      if(frame == null)
      {
         throw new NullPointerException("The frame musn't be null !");
      }
   ...
   private void forceSizeDialog(final int width, final int height)
   {
      ...
      this.mutexForced.lock();

      Utilities.sleep(16);

      Dimension dimension = this.dialog.getSize();
      Debug.println(DebugLevel.DEBUG, "WANTED : ", dimension, "->", width, "x", height);

      while((dimension.width != width) || (height != dimension.height))
      {
         Debug.println(DebugLevel.DEBUG, dimension, "->", width, "x", height);
      ...
      Debug.println(DebugLevel.DEBUG, "FINISHED : ", this.dialog.getSize(), "<->", width, "x", height);

      this.mutexForced.unlock();
   }
   ...
   {
      final WindowablePanelEvent windowablePanelEvent = new WindowablePanelEvent(this, WindowablePanelEvent.EVENT_WINDOWABLE_PANEL_ATTACH);
      final WindowablePanelListener[] windowablePanelListeners = this.listenerList.getListeners(WindowablePanelListener.class);
   ...
   {
      final WindowablePanelEvent windowablePanelEvent = new WindowablePanelEvent(this, WindowablePanelEvent.EVENT_WINDOWABLE_PANEL_CLOSE);
      final WindowablePanelListener[] windowablePanelListeners = this.listenerList.getListeners(WindowablePanelListener.class);
      for(final WindowablePanelListener windowablePanelListener : windowablePanelListeners)
      {
   ...
   {
      final WindowablePanelEvent windowablePanelEvent = new WindowablePanelEvent(this, WindowablePanelEvent.EVENT_WINDOWABLE_PANEL_DETACH);
      final WindowablePanelListener[] windowablePanelListeners = this.listenerList.getListeners(WindowablePanelListener.class);
      for(final WindowablePanelListener windowablePanelListener : windowablePanelListeners)
      {
   ...
   {
      final WindowablePanelEvent windowablePanelEvent = new WindowablePanelEvent(this, WindowablePanelEvent.EVENT_WINDOWABLE_PANEL_HIDE);
      final WindowablePanelListener[] windowablePanelListeners = this.listenerList.getListeners(WindowablePanelListener.class);
      for(final WindowablePanelListener windowablePanelListener : windowablePanelListeners)
      {
   ...
   {
      final WindowablePanelEvent windowablePanelEvent = new WindowablePanelEvent(this, WindowablePanelEvent.EVENT_WINDOWABLE_PANEL_OPEN);
      final WindowablePanelListener[] windowablePanelListeners = this.listenerList.getListeners(WindowablePanelListener.class);
      for(final WindowablePanelListener windowablePanelListener : windowablePanelListeners)
      {
   ...
   {
      final WindowablePanelEvent windowablePanelEvent = new WindowablePanelEvent(this, WindowablePanelEvent.EVENT_WINDOWABLE_PANEL_SHOW);
      final WindowablePanelListener[] windowablePanelListeners = this.listenerList.getListeners(WindowablePanelListener.class);
      for(final WindowablePanelListener windowablePanelListener : windowablePanelListeners)
      {
   ...
   public void setHide(final boolean hide)
   {
      ...
      if(this.hide == true)
      {
         ...
         Debug.println(DebugLevel.DEBUG, "MEM=", dimension);
      }
      ...
      if(this.hide == true)
      {
         if(this.isWindow == true)
         {
            ...
            Debug.println(DebugLevel.DEBUG, "MEM2=", dimension);

            Debug.println(DebugLevel.DEBUG, "BEFORE=", this.dialog.getSize());
            ...
            Debug.println(DebugLevel.DEBUG, "AFTER=", this.dialog.getSize());
         }
      }
      else
      {
