...
public class UndoRedoManager
{
    ...
    */
   public int getUndoRedoReadIndex()
   {
    ...
    * 
    * @param indexUndoRedo
    *           Index of remove undo/redo action
    */
   public void removeSpecificUndoRedo(final int indexUndoRedo)
   {
      if((indexUndoRedo < 0) || (indexUndoRedo >= this.undoRedoIndex))
      {
         throw new IllegalArgumentException("Index specified dosen't exist. Must actual in [0, " + this.undoRedoIndex + "[ not " + indexUndoRedo);
      }
      ...
      System.arraycopy(this.undoRedoActionList, indexUndoRedo + 1, this.undoRedoActionList, indexUndoRedo, UndoRedoManager.UNDO_REDO_LIMIT - indexUndoRedo - 1);
