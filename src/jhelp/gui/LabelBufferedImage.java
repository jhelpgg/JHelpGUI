      ...
      extends JComponent
{
      ...
      public void run()
      {
         ...
         try
         {
            if((LabelBufferedImage.this.gif != null) && (LabelBufferedImage.this.gif.isUsable() == true))
            {
               ...
               LabelBufferedImage.this.bufferedImage = LabelBufferedImage.this.gif.getImage(LabelBufferedImage.this.index);
               final Dimension dimension = new Dimension(LabelBufferedImage.this.gif.getWidth(), LabelBufferedImage.this.gif.getHeight());
   ...
   protected void paintComponent(final Graphics g)
   {
      ...
      if((this.rectangle != null) && (this.color != null) && (this.colorBack != null))
      {
         ...
         g.fillRect((this.rectangle.x + this.rectangle.width) - 1, this.rectangle.y - 1, 3, this.rectangle.height + 2);
         g.fillRect(this.rectangle.x - 1, this.rectangle.y - 1, 3, this.rectangle.height + 2);
         g.fillRect(this.rectangle.x - 1, (this.rectangle.y + this.rectangle.height) - 1, this.rectangle.width + 2, 3);
