...
public final class JHelpAnimation
{
   ...
   public static final Interpolation INTERPOLATION_EXPONENTIAL = new Interpolation()
                                                               {
                                                                   ...
                                                                   *           parameter
                                                                   * @return f(t)
                                                                   * @see jhelp.gui.game.JHelpAnimation.Interpolation#interpolation(double)
                                                                   */
                                                                  @Override
                                                                  public double interpolation(final double t)
                                                                  {
                                                                     return UtilMath.interpolationExponential(t);
                                                                  }
                                                               };
   /**
   ...
   public static final Interpolation INTERPOLATION_LOGARITHM   = new Interpolation()
                                                               {
                                                                  ...
                                                                  public double interpolation(final double t)
                                                                  {
                                                                     return UtilMath.interpolationLogarithm(t);
                                                                  }
                                                               };
   /**
   ...
   public static final Interpolation INTERPOLATION_SINUS       = new Interpolation()
                                                               {
                                                                  ...
                                                                  public double interpolation(final double t)
                                                                  {
                                                                     return UtilMath.interpolationSinus(t);
                                                                  }
                                                               };
   ...
   boolean animate(final JHelpSprite sprite)
   {
      ...
      final double t = frameEnd.interpolation.interpolation(((double) framePosition - (double) start) / ((double) end - (double) start));
    ...
    *           Sprite Y postition
    * @param interpolation
    *           Interpolation to use to go to this position
    */
    ...
    * 
    * @param fps
    *           New animation FPS (Frame Per Second)
    */
