      ...
      implements Positionable
{
   ...
   {
      return (x >= this.x) && (y >= this.y) && (x < (this.x + this.image.getWidth())) && (y < (this.y + this.image.getHeight()));
   }
    ...
    * 
    * @param gameDynamic
    *           Game where animation played. If {@code null}, no animation played
    * @param enable
    *           New enable state
    */
   public final void setEnable(final JHelpGameDynamic gameDynamic, final boolean enable)
   {
      this.setEnable(gameDynamic, enable, SensitiveElement.DEFAULT_TRANSITION_TIME);
   }
    ...
    *           New enable state
    * @param millisecond
    *           Time, in millisecond, for do the animation
    */
   public final void setEnable(final JHelpGameDynamic gameDynamic, final boolean enable, final int millisecond)
   {
    ...
    * 
    * @param gameDynamic
    *           Game where play the animation
    * @param millisecond
    *           Time to do the animation in millisecond
    */
   public final void toColor(final JHelpGameDynamic gameDynamic, final int millisecond)
   {
      synchronized(this.lock)
      {
         ...
         this.imageTransition = new ImageTransition(UtilDynamic.millisecondToNumberOfFrame(millisecond), grey, this.image, 1, false);
         this.isGrey = false;
   ...
   public final void toGrey(final JHelpGameDynamic gameDynamic, final int millisecond)
   {
      synchronized(this.lock)
      {
         ...
         this.imageTransition = new ImageTransition(UtilDynamic.millisecondToNumberOfFrame(millisecond), this.image, grey, 1, false);
         this.isGrey = true;
         gameDynamic.playAnimation(this.imageTransition);
      }
   }
