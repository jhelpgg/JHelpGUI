...
public enum ButtonShape
{
   ...
   RECTANGLE()
   {
       ...
       * @see jhelp.gui.game.ButtonShape#computeShapeInsideUpLeftCorner(int, int)
       */
      @Override
       ...
       *           Internal height desired
       * @return Total size
       * @see jhelp.gui.game.ButtonShape#computeShapeTotalSize(int, int)
       */
      @Override
       ...
       * @see jhelp.gui.game.ButtonShape#draw(int, int, int, int, int, jhelp.util.gui.JHelpImage)
       */
      @Override
      public void draw(final int x, final int y, final int width, final int height, final int color, final JHelpImage parent)
      {
       ...
       * @param parent
       *           Image parent where draw
       * @see jhelp.gui.game.ButtonShape#fill(int, int, int, int, int, jhelp.util.gui.JHelpImage)
       */
      @Override
      public void fill(final int x, final int y, final int width, final int height, final int color, final JHelpImage parent)
      {
         final boolean draw = parent.isDrawMode();
       ...
       * @param parent
       *           Image parent where draw
       * @see jhelp.gui.game.ButtonShape#fill(int, int, int, int, jhelp.util.gui.JHelpDrawable, jhelp.util.gui.JHelpImage)
       */
      @Override
   ...
   ROUND_RECTANGLE()
   {
      ...
      public Dimension computeShapeTotalSize(final int insideWidth, final int insideHeight)
      {
         ...
         return new Dimension(insideWidth + more + ButtonShape.BORDER_2, insideHeight + more + ButtonShape.BORDER_2);
      }
   ...
   SAUSAGE()
   {
      ...
      public Dimension computeShapeTotalSize(final int insideWidth, final int insideHeight)
      {
         if(insideWidth >= insideHeight)
         {
            return new Dimension(insideWidth + insideHeight + ButtonShape.BORDER_2, insideHeight + ButtonShape.BORDER_2);
         }

         return new Dimension(insideWidth + ButtonShape.BORDER_2, insideHeight + insideWidth + ButtonShape.BORDER_2);
      }
    ...
    *           Image parent where draw
    */
   public abstract void draw(final int x, final int y, final int width, final int height, final int color, final JHelpImage parent);
    ...
    *           Image parent where draw
    */
   public abstract void fill(final int x, final int y, final int width, final int height, final int color, final JHelpImage parent);
    ...
    *           Image parent where draw
    */
   public abstract void fill(final int x, final int y, final int width, final int height, final JHelpDrawable drawable, final JHelpImage parent);
}