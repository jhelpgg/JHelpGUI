      ...
      implements PropertyChangeListener
{
    ...
    */
   private static JHelpImage obtainImage(final GenericAction genericAction, final JHelpFont font, final int foreground, final int background,
         final ButtonShape buttonShape)
   {
      JHelpImage image = genericAction.getLargeIcon();

      if(image == null)
      {
         image = genericAction.getSmallIcon();
    ...
    *           Button shape
    */
   public SensitiveButton(final JHelpGameDynamic gameDynamic, final int x, final int y, final GenericAction genericAction, final JHelpFont font,
         final int foreground, final int background, final ButtonShape buttonShape)
   {
      ...
      if(gameDynamic == null)
      {
         throw new NullPointerException("gameDynamic musn't be null");
      }
   ...
   {
      this.genericAction.actionPerformed(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, this.genericAction.getName()));
   }
   ...
   {
      this.setEnable(this.gameDynamic, this.genericAction.isEnabled());
   }
   ...
   public void setCursor(final Cursor cursor)
   {
      if(cursor == null)
      {
         throw new NullPointerException("cursor musn't be null");
      }
