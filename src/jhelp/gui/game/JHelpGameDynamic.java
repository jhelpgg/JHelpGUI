      ...
      extends JHelpFrame
{
         ...
         implements KeyListener, MouseListener, MouseMotionListener
   {
      ...
      private void mouseState(final MouseEvent mouseEvent)
      {
         ...
         JHelpGameDynamic.this.buttonLeft = (modifiers & InputEvent.BUTTON1_DOWN_MASK) == InputEvent.BUTTON1_DOWN_MASK;
         JHelpGameDynamic.this.buttonMiddle = (modifiers & InputEvent.BUTTON2_DOWN_MASK) == InputEvent.BUTTON2_DOWN_MASK;
         JHelpGameDynamic.this.buttonRight = (modifiers & InputEvent.BUTTON3_DOWN_MASK) == InputEvent.BUTTON3_DOWN_MASK;
      }
   ...
   public JHelpGameDynamic(final String title, final Resources resources)
   {
      ...
      this.keyAssociations.put(this.preferences.getValue(ActionKey.ACTION_CANCEL.name(), KeyEvent.VK_X), ActionKey.ACTION_CANCEL);
      ...
      this.keyAssociations.put(this.preferences.getValue(ActionKey.ACTION_FIRE_2.name(), KeyEvent.VK_CONTROL), ActionKey.ACTION_FIRE_2);
      this.keyAssociations.put(this.preferences.getValue(ActionKey.ACTION_LEFT.name(), KeyEvent.VK_LEFT), ActionKey.ACTION_LEFT);
      this.keyAssociations.put(this.preferences.getValue(ActionKey.ACTION_MENU.name(), KeyEvent.VK_M), ActionKey.ACTION_MENU);
      ...
      this.keyAssociations.put(this.preferences.getValue(ActionKey.ACTION_SPECIAL.name(), KeyEvent.VK_W), ActionKey.ACTION_SPECIAL);
      this.keyAssociations.put(this.preferences.getValue(ActionKey.ACTION_START.name(), KeyEvent.VK_S), ActionKey.ACTION_START);
      this.keyAssociations.put(this.preferences.getValue(ActionKey.ACTION_EXIT.name(), KeyEvent.VK_ESCAPE), ActionKey.ACTION_EXIT);
   ...
   void manageEvents()
   {
      ...
      if((this.overArea != null) && (this.overArea != over))
      {
         ...
         {
            mouseSensitiveAreaListener.mouseExitArea(this.overArea, relativeX, relativeY, this.mouseX, this.mouseY, this.buttonLeft, this.buttonMiddle,
                  this.buttonRight);
         }
      }
      ...
      if((over != null) && (over != this.overArea))
      {
         ...
         for(final MouseSensitiveAreaListener mouseSensitiveAreaListener : this.mouseSensitiveAreaListeners)
         {
            mouseSensitiveAreaListener.mouseEnterArea(over, relativeX, relativeY, this.mouseX, this.mouseY, this.buttonLeft, this.buttonMiddle,
                  this.buttonRight);
         }
      }
   ...
   protected void createComponents()
   {
      ...
      this.dynamicImage = new JHelpDynamicImage(bounds.width - insets.left - insets.right, bounds.height - insets.top - insets.bottom);
   ...
   public void setAreasVisible(final boolean visible)
   {
      ...
      for(final MouseSensitiveArea mouseSensitiveArea : this.mouseSensitiveAreas)
      {
         ...
         image.fillRectangle(bounds.x, bounds.y, bounds.width, bounds.height, mouseSensitiveArea.getColor());
      }
