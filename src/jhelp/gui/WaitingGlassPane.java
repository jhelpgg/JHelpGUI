      ...
      extends JPanel
{
         ...
         extends Thread
   {
      ...
      public void run()
      {
         ...
         while(WaitingGlassPane.this.threadRepaint != null)
         {
            ...
            {
               WaitingGlassPane.this.index = (WaitingGlassPane.this.index + 1) % WaitingGlassPane.this.arrayListWaitingImage.size();
            }
    ...
    * 
    * @param frame
    *           To add the waiting glass plane
