      ...
      implements LayoutManager
{
    ...
    * 
    * @param parent
    *           Container that contains the component
    * @param index
    *           Component index in container
    ...
    * 
    * @param parent
    *           Container to compute its minimum dimension
    ...
    * 
    * @param parent
    *           Container to compute its preferred dimension
