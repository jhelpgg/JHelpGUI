...
public class TableLayout implements LayoutManager2
{
     ...
     * After this this minimum cell X and Y will be 0
     *
    ...
    public void addLayoutComponent(Component component, Object constraints)
    {
        ...
        if (!(constraints instanceof Constraints))
        {
            throw new IllegalArgumentException(
                    "constraints MUST be an instance of " + Constraints.class.getName() + " not " + constraints.getClass()
                                                                                                               .getName());
        }
                ...
                for (int i = 0; i < nb; i++)
                {
                    ...
                    if (component.isVisible() && constraints != null)
                    {
                        ...
                        component.setSize(constraints.width * this.cellWidth - this.margins.left - this.margins.right,
                                          constraints.height * this.cellHeight - this.margins.top - this.margins.bottom);
                    }
                }
            }
        }
