      ...
      implements LayoutManager
{
    ...
    *
    * @param maximumWidth
    *           Maximum width. Can use {@link Integer#MAX_VALUE} for no limit
    * @param maximumHeight
    *           Maximum height. Can use {@link Integer#MAX_VALUE} for no limit
    */
   ...
   public void layoutContainer(final Container parent)
   {
      ...
      synchronized(parent.getTreeLock())
      {
         ...
         component.setBounds(insets.left, insets.right, Math.min(this.maximumWidth, parentSize.width), Math.min(this.maximumHeight, parentSize.height));
      }
   }
   ...
   {
      if((parent.getComponentCount() == 0) || (parent.getComponent(0).isVisible() == false))
      {
