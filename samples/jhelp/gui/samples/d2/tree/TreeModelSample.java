      ...
      extends JHelpTreeModel<TreeNodeSample>
{
    ...
    *           Child index
    * @return Child
    * @see jhelp.gui.twoD.JHelpTreeModel#getChild(java.lang.Object, int)
    */
   @Override
   public TreeNodeSample getChild(final TreeNodeSample parent, final int index)
   {
      final Tree<TreeNodeSample> node = this.tree.searchBranch(new SearchByID(parent.getID()), SearchMode.LEFT_TO_RIGHT_DEPTH, false);
    ...
    * @see jhelp.gui.twoD.JHelpTreeModel#getParent(java.lang.Object)
    */
   @Override
   public TreeNodeSample getParent(final TreeNodeSample child)
   {
      final Tree<TreeNodeSample> node = this.tree.searchBranch(new SearchByID(child.getID()), SearchMode.LEFT_TO_RIGHT_DEPTH, false);
    ...
    * 
    * @return Tree root
    * @see jhelp.gui.twoD.JHelpTreeModel#getRoot()
    */
   @Override
   public TreeNodeSample getRoot()
   {
    ...
    * @see jhelp.gui.twoD.JHelpTreeModel#isExpanded(java.lang.Object)
    */
   @Override
   public boolean isExpanded(final TreeNodeSample node)
   {
    ...
    * @param expand
    *           New expand state
    * @see jhelp.gui.twoD.JHelpTreeModel#setExpand(java.lang.Object, boolean)
    */
   @Override
   public void setExpand(final TreeNodeSample information, final boolean expand)
   {
